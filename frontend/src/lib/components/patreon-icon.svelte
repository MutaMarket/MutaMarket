<script lang="ts">
  // The Patreon mark of the legacy PatreonAd.vue (Font Awesome Free
  // 6.7.2 "patreon", https://fontawesome.com/license/free), filled with
  // currentColor.
  let { class: className = 'h-[1em] w-[1em]' }: { class?: string } = $props();
</script>
