<script lang="ts">
	...
	// picks the set): three variance-search submenus, share, copy and
	// image groups, and the admin estimate action. Collection, workbench,
	// note and asking-price entries arrive with their backend features.
	import { Copy, ExternalLink, Image as ImageIcon, Search, Sparkles } from '@lucide/svelte';
